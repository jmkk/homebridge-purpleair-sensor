...
exports.SensorReading = exports.parsePurpleAirJson = void 0;
function parsePurpleAirJson(data, averages, conversion) {
    const conv = conversion !== null && conversion !== void 0 ? conversion : 'None';
    const pm25 = (() => {
        switch (averages) {
...
exports.parsePurpleAirJson = parsePurpleAirJson;
class SensorReading {
    /**
     * Constructor
     ...
     */
    constructor(sensor, pm25, voc, conversion) {
        this.sensor = sensor;
        this.pm25 = pm25;
        this.voc = voc;
    ...
    get airQualityHomekitReading() {
        return SensorReading.aqiToHomekit(this.aqi);
    }
    static aqiToHomekit(aqi) {
